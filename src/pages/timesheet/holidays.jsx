...
const Holidays = () => {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(Holiday.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, Holiday.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(Holiday.slice(start, end));
       }, [Holiday, currentPage, rowsPerPage]);
