...
const JobCandidates = () => {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(JobCandidate.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, JobCandidate.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(JobCandidate.slice(start, end));
       }, [JobCandidate, currentPage, rowsPerPage]);
