...
const Projects = () => {
  ...
  const [paginated, setPaginated] = useState(Projects.slice(0, rowsPerPage));
    ...
    const endEntry = Math.min(currentPage * rowsPerPage, Projects.length);
    useEffect(() => {
        const start = (currentPage - 1) * rowsPerPage;
        const end = start + rowsPerPage;
        setPaginated(Projects.slice(start, end));
