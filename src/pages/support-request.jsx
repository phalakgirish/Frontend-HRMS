...
const SupportRequest = () => {
  ...
  try {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(SupportRequest.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, SupportRequest.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(SupportRequest.slice(start, end));
       }, [SupportRequest, currentPage, rowsPerPage]);
