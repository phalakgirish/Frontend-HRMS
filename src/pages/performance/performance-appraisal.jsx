...
const PerformanceAppraisal = () => {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
      const [paginated, setPaginated] = useState(PerformanceAppraisal.slice(0, rowsPerPage));
        ...
        const endEntry = Math.min(currentPage * rowsPerPage, PerformanceAppraisal.length);
        useEffect(() => {
            const start = (currentPage - 1) * rowsPerPage;
            const end = start + rowsPerPage;
            setPaginated(PerformanceAppraisal.slice(start, end));
        }, [PerformanceAppraisal, currentPage, rowsPerPage]);
