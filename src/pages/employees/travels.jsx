...
const Travels = () => {
    ...
    const [paginated, setPaginated] = useState(Travel.slice(0, rowsPerPage));
      ...
      const endEntry = Math.min(currentPage * rowsPerPage, Travel.length);
      useEffect(() => {
          const start = (currentPage - 1) * rowsPerPage;
          const end = start + rowsPerPage;
          setPaginated(Travel.slice(start, end));
      }, [Travel, currentPage, rowsPerPage]);
