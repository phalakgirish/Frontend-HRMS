...
const Transfers = () => {
  ...
  const customStyles = {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(Transfer.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, Transfer.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(Transfer.slice(start, end));
       }, [Transfer, currentPage, rowsPerPage]);
