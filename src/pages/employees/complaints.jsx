...
const Complaints = () => {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(Complaint.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, Complaint.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(Complaint.slice(start, end));
       }, [Complaint, currentPage, rowsPerPage]);
