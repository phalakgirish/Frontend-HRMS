...
const Resignations = () => {
    ...
    const [paginated, setPaginated] = useState(Resignation.slice(0, rowsPerPage));
    ...
    const endEntry = Math.min(currentPage * rowsPerPage, Resignation.length);
    useEffect(() => {
        const start = (currentPage - 1) * rowsPerPage;
        const end = start + rowsPerPage;
        setPaginated(Resignation.slice(start, end));
    }, [Resignation, currentPage, rowsPerPage]);
