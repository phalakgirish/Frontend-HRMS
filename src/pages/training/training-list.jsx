...
const TrainingList = () => {
    ...
    const totalPages = Math.ceil(totalEntries / rowsPerPage);
     const [paginated, setPaginated] = useState(TrainingList.slice(0, rowsPerPage));
       ...
       const endEntry = Math.min(currentPage * rowsPerPage, TrainingList.length);
       useEffect(() => {
           const start = (currentPage - 1) * rowsPerPage;
           const end = start + rowsPerPage;
           setPaginated(TrainingList.slice(start, end));
       }, [TrainingList, currentPage, rowsPerPage]);
